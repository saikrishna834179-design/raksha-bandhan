// Welcome to the Raksha Bandhan Gift Website ❤️

// We'll add JavaScript section by section.
...
btn.onclick = function () {
    ...
    btn.innerHTML = "⏳ Countdown Started";
...
const targetDate = new Date("August 28, 2026 9:00:00").getTime();
